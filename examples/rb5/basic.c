...
void set_task_pos(double* v){    
    sprintf(buf, "movetcp 0.05, 0.05, %.2lf, %.2lf, %.2lf, %.2lf, %.2lf, %.2lf", v[0]*1000, v[1]*1000, v[2]*1000, v[3]*(180/M_PI), v[4]*(180/M_PI), v[5]*(180/M_PI));
...
void set_task_path(int num, double* v){
    ...
    sprintf(buf+len, "move_pb_run(20, 0)");
