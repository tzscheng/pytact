 ...
 * prototypes for the storage API (tact_set_mesh_path/tact_set_hfield_data/load_obj/
 ...
 * first use; `mesh_path[idx]` is set by tact_set_mesh_path() from Python at build time. */
...
/* Per-slot height-field storage. Pushed from Python via tact_set_hfield_data().
